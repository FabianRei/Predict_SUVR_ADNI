...
cross_validation_gbdt(data, params, activations=with_activations, cval_range=5, extra_folder='categ_variables')

features = ['t0_suvr', 'sex', 'weight', 'delta_time', 'apoe', 'mmsescore', 'faqtotal', 'age']
for f in features:
    cross_validation_gbdt(data, params, activations=with_activations, cval_range=5, exclude=f, extra_folder='exclusions_wo_acs3')
# cross_validation_gbdt(data, params, activations=False, cval_range=5)
#test
