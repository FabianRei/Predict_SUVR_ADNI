...
fp = r'C:\Users\Fabian\stanford\fed_learning\federated_learning_data\fc_activations_better_weighting.pickle'
...
for s in np.unique(res_dict['subs']):
    ...
    if len(test)*0.2>np.sum(test==4):
        test[samples] = 4
out_path = r'C:\Users\Fabian\stanford\fed_learning\rsync\fl\rf_data_train_test_crossval_better_weighting.pickle'
res_dict['test'] = test
